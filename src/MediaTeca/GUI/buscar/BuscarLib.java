 ...
 * @author Daniel
 */
public class BuscarLib extends javax.swing.JFrame {
    /**
    ...
    public static void buscarLibro(int codigo) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscarLib.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
